            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <form onSubmit={handleSubmit} class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6 p-4">
                        ...
                        <div class="flex flex-col mb-4">
                            <label for="listaProductos" class="block mb-2 text-sm font-medium text-gray-900">Producto</label>
                            <select name="listaProductos" id="listaProductos" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5">
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <input type="number" name="quantity" id="quantity" placeholder="quantity" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5" />
                        </div>
                    </div>
